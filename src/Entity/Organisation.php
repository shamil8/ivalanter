...
class Organisation
{
    ...
    /**
     * @ORM\Column(type="string", length=255, options={"comment":"Название организации"})
     */
    private $name;

    /**
     * @ORM\Column(type="string", length=255, options={"comment":"Сфера деятельности"})
     */
    private $area;
    ...
    /**
     * staff organisation - Сотрудники организации
     *
